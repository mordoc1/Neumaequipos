                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/red/104237.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Red Lubricación" href="images/2.0/red/104237.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104237">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Pistola control aceite cuenta litros extencion rigida</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">
                                    *Procedencia Chino </p><p align="justify">*Procedencia Chino </p><p align="justify">Digital</p><p align="justify">Valvula manual </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104237</h3>
                                </div>
