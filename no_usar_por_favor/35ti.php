                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/105227.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/105227.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105227">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora TECO 35 TI  </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">
                                    	Desmontadora semi automática para neumáticos de auto y camionetas desde aro 10" hasta aro 23". Accionamiento Electro-Neumático. Incluye estanque acumulador. Plato autocentrante de doble sentido de rotación. Brazo horizontal a bandera de movimiento lateral y bloqueo moral.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105227</h3>
                                </div>
