                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/104781.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/104781.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104781">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora CamiónTECO 52 </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10">
                                    	ESPECIFICACIONES TÉCNICAS
                                        -Diámetro interno: 14" - 26"
                                        -Diámetro externo: 1600mm
                                        -Motor voltaje: 220v / 1.5 KW
                                        -Fuerza destolonadora: 2500 Kg
                                        -Peso neto: 500 kg
                                        -Tamaño del paquete:2000x1580x950mm
                                        -Sistema motor hidrahulico
                                        -Operacion electro-hidrahulica
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104781</h3>
                                </div>
