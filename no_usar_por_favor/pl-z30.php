                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/105326.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/105326.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105326">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#"> Elevador Tijera frenos PL-Z30 PULI</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">La plataforma elevadora de tijera de capacidad media es el elevador sobre el suelo perfecto para aquellos clientes con restricciones de altura del techo y la necesidad de “elevaciones suficientes” para levantar camionetas. </p><p align="justify">Este elevador de tijera de altura completa PULI también es perfecto para aquellos talleres de servicio que desean evitar el aspecto abarrotado de docenas de columnas de elevadores verticales.</p>
                                    ...
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105326</h3>
                                </div>
